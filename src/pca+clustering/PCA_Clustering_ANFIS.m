...
% 4. PCA used with 4 principal components
...
% decreasing features
[coeff_trim_data_default,~,latent_trim_data_default] = pca(trim_data_default);
trans_trim_data_default = coeff_trim_data_default(:,1:4);
trim_data_default = trim_data_default*trans_trim_data_default;

[coeff_trim_data_no_default,~,latent_trim_data_no_default] = pca(trim_data_no_default);
trans_trim_data_no_default = coeff_trim_data_no_default(:,1:4);
trim_data_no_default = trim_data_no_default*trans_trim_data_no_default;

% fuzzy clustering
cd = 6;                       % number of default clusters
cnd = 3;                       % number of non default clusters
